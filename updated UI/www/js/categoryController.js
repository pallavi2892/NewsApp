...
app.controller('addNewsController',function ($scope,$location,$cordovaCamera,$cordovaGeolocation, $http, $cordovaCapture) {
    $scope.back = function() {
            $location.path('/category');
        }
            ...
            var i,  len;
               $scope.path2 ="";
                for (i = 0, len = videoData.length; i < len; i += 1) {
                   $scope.path2 = videoData[i].fullPath;
